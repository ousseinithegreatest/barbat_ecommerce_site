<?php
    ...
    if(!empty($_POST)) 
    {
        ...
        { 
            ...
            if($isImageUpdated)
            {
                $statement = $db->prepare("UPDATE items  set name = ?, description = ?, price = ?, category = ?, image = ? WHERE idProduit = ?");
                $statement->execute(array($name,$description,$price,$category,$image,$id));
            }
            else
            {
                $statement = $db->prepare("UPDATE items  set name = ?, description = ?, price = ?, category = ? WHERE idProduit = ?");
        ...
        {
            $db = Database::connect();
            $statement = $db->prepare("SELECT * FROM items where idProduit = ?");
